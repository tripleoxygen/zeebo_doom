...
default_t defaults[] =
{
  ...
  {"mus_pause_opt",{&mus_pause_opt},{2},0,2, // CPhipps - music pausing
   ...
   {"snd_channels",{&default_numChannels},{4},1,4,
...
//   {"joy_down",{&joydown},{0},  UL,UL,def_int,ss_none},
  ...
  {"joyb_escape",{&joybescape},{4},0,UL,
   def_int,ss_keys}, // joystick button number to use for escape/menu
  {"joyb_yes",{&joybyes},{5},0,UL,
   def_int,ss_keys}, // joystick button number to use for confirmation ('yes')
  {"joyb_changeweapon",{&joybchangeweapon},{6},0,UL,
   def_int,ss_keys}, // joystick button number to use for changing weapons
